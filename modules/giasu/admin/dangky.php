 ...
 * @Createdate Mon, 16 Jun 2014 12:25:02 GMT
 */
...
if ( $nv_Request->isset_request( 'submit', 'post' ) )
{
	...
	$row['begindate'] = $nv_Request->get_int( 'begindate', 'post', 0 );
	$row['enddate'] = $nv_Request->get_int( 'enddate', 'post', 0 );
