  ...
  <div class="form-group">
		<h2>Đăng ký gia sư</h2>
		 <div class="form-group">
			...
			<input name="name" id="name" type="text" class="form-control" placeholder="Tên người đăng ký" > 	
		 </div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<textarea name="comment" id="comment" class="form-control" placeholder="Yêu cầu gia sư"></textarea>	
		</div>
